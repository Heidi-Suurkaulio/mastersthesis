...
\begin{tcbitemize}[
	...
	\tcbitem[width=1.0\linewidth]
	\textbf{Työn otsikko}\\
	Game of Networks: Family Ties Within the Swedish Council of the Realm (1520-1680)
\end{tcbitemize}
...
\begin{tcolorbox}
	\textbf{Asiasanat}\\
	Verkostoanalyysi, digihumanismi, varhaismoderni aika, Ruotsin valtakunta, valtaneuvosto, Gephi, Python, 
	network analysis, computational history, early modern period, Swedish council of the Realm ...
\end{tcolorbox}
